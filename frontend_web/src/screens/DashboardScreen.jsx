...
import { Link2, Mic, ScanLine, WalletCards, ChevronRight } from 'lucide-react';
    ...
    <div className="relative min-h-screen px-4 pb-6 pt-4">
      <div className="mb-5 flex items-center justify-between">
        ...
        <button className="rounded-full bg-white p-3 shadow-md">
          <WalletCards size={18} className="text-forest" />
        </button>
      </div>

      <div className="rounded-[28px] bg-gradient-to-br from-forest to-[#0a3e44] p-5 text-white shadow-2xl shadow-forest/20">
        <p className="text-xs uppercase tracking-[0.3em] text-white/70">Trust Score</p>
      ...
      <div className="mt-5 flex items-center justify-between">
        <h3 className="text-lg font-extrabold text-slate-900">Recent Activities Ledger</h3>
        ...
        <div className="absolute inset-0 z-40 flex items-end bg-slate-950/50 px-4 pb-4 backdrop-blur-sm">
          <div className="w-full rounded-[28px] bg-white p-5 shadow-2xl">
            ...
            <div className="space-y-3">
              ...
              <input className="w-full rounded-2xl border border-slate-200 bg-[#F8F9FA] px-4 py-3 text-sm" placeholder="Transaction ID" value={paymentForm.transactionId} onChange={(e) => setPaymentForm((current) => ({ ...current, transactionId: e.target.value }))} />
